...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [4] = { ENCODER_CCW_CW(C(KC_PGUP), C(KC_PGDN)),ENCODER_CCW_CW(KC_7, KC_8),				        ENCODER_CCW_CW(KC_VOLD, KC_VOLU),ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
...
[_QWERTY] = LAYOUT(
	...
	LT(4,KC_Z),	KC_X,	   KC_C,		           KC_V,		           KC_B,				        KC_N,	KC_M,		        KC_COMM,  	   KC_DOT,	LT(4,KC_SLSH),
			    TG(1),	   LALT_T(KC_TAB),         LCTL_T(KC_BSPC),        MO(2),  	 KC_LGUI, KC_NUM,	MO(2),	KC_SPC,		        LT(1,KC_ENT),  KC_MUTE
),
